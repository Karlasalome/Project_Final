...
//get the data from the default url  
...
// this lines works, renders the data. do not touch
    var filteredData =  
 ...
 //creates the tags in the values, find a better way     WORK HERE!!!!!!!!
      // var markerArray = [];

      // L.Marker(filteredData, {
